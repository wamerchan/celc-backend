...
const metricas_controller_1 = require("./metricas.controller");
...
exports.MetricasModule = MetricasModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [metricas_controller_1.MetricasController],
        providers: [metricas_service_1.MetricasService],
    })
], MetricasModule);
