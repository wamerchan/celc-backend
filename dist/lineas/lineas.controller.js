...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todas las líneas de producción' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Crear una nueva línea de producción' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar una línea de producción' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(new role_guard_1.RoleGuard([1, 2])),
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar una línea de producción' }),
