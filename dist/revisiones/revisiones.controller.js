...
], RevisionesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], RevisionesController.prototype, "findById", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], RevisionesController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], RevisionesController.prototype, "update", null);
exports.RevisionesController = RevisionesController = __decorate([
    (0, common_1.Controller)('api/revisiones'),
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard),
    __metadata("design:paramtypes", [revisiones_service_1.RevisionesService])
