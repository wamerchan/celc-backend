...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login exitoso, retorna token JWT' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Verificar token JWT y retornar perfil completo' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token válido, retorna usuario completo' }),
